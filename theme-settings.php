...
function nexus_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['nexus_settings']['slideshow']['video'] = array(
    '#type' => 'fieldset',
    '#title' => t('video'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['nexus_settings']['slideshow']['video']['video_head'] = array(
    '#type' => 'textfield',
    '#title' => t('Video Headline'),
    '#default_value' => theme_get_setting('video_head','nexus'),
  );
  $form['nexus_settings']['slideshow']['video']['video_desc'] = array(
    '#type' => 'textarea',
    '#title' => t('Video Description'),
    '#default_value' => theme_get_setting('video_desc','nexus'),
  );
  $form['nexus_settings']['slideshow']['video']['video_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Video URL'),
    '#default_value' => theme_get_setting('video_url','nexus'),
  );
